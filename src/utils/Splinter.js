    ...
    constructor(jsonFile, turtleFile) {
        ...
        this.graph = {
            nodes: [
                ...
                { id: 5 , name : "Matlab", img : imgs[2], level : 3 },
                { id: 6 , name : "Nifti", img : imgs[1], level : 3 },
                { id: 7 , name : "Matlab", img : imgs[2], level : 3 },
                { id: 8 , name : "Matlab", img : imgs[1], level : 4 },
                { id: 9 , name : "Nifti", img : imgs[2], level : 4 }
            ],
            links: [
                { source: 1, target: 2},
                { source: 1, target: 3},
